 ...
 */
function zero_themeajax_set_type( $type ) {
  $types = array(
 ...
 */
function zero_themeajax_handler() {
...
add_action('wp_ajax_themeajax', 'zero_themeajax_handler');
add_action('wp_ajax_nopriv_themeajax', 'zero_themeajax_handler');