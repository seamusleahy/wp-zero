...
class ZEROTHEME_Active_Trail_Item {
	 ...
	 *
	 *
	 * @param unknown $title      string - the title of the menu item
	 * @param unknown $url        string - the URL for the item
	 * @param unknown $id         - the menu ID
	 * @param unknown $attributes array (optional) - key value pair for attributes
	 */
